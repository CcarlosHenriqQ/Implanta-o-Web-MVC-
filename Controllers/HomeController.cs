...
public class HomeController : Controller
{
    ...
    {
        //instancia do tipo Cliente atribui os clientes
        Cliente cliente1 = new Cliente(01, "Carlos H. Freitas", "857.032.950-41", "carlosmoura2002.ch@outlook.com", "Tobi");
